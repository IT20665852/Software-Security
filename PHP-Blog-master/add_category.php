...
if (!isset($_SESSION['user_id']) || $_SESSION['role'] !== 'admin') {
    die('Access Denied: Only admin users can access this page.');
}
?>
...
<meta http-equiv="Content-Security-Policy" content="default-src 'self'; script-src 'self' https://cdn.ckeditor.com; style-src 'self' 'unsafe-inline'; img-src 'self' data:;">
                    ...
                    <form action="assest/insert.php?type=category" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="custom-file">
                                <input type="file" class="custom-file-input" name="catImage" id="catImage" accept=".jpg,.jpeg,.png" required>
